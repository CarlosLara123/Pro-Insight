...
<div class="container">
    <div class="row">
        <table class="table table-striped">
            ...
            <tbody id="data">
            @if(count($containerProducts)>0)
               @foreach($containerProducts as $container_product)
                <tr>
                    <td>{{ $container_product->idContainerProducts }}</td>
                    <td>{{ $container_product->container->arrival_date }}</td>
                    <td>{{ $container_product->product->name }}</td>
                    <td>{{ $container_product->creation_date }}</td>
                    <td>{{ $container_product->update_date }}</td>
                </tr>
               @endforeach
            @else
                <tr>
